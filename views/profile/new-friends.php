...
$this->title = Yii::t('app', 'New friends');
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="pull-right">
                                    ...
                                    <button onclick="removeFriend(<?= $item->user->id ?>)" type="button" class="btn btn-danger"><i class="fas fa-minus"></i></button>
                                </div>
                            </div>
                        </div>
                    </li>
...
<script>
    function removeFriend(id) {
        $.ajax({
            url: '<?= Url::toRoute('/profile/ajax-remove-friend/', true) ?>',
            type: 'post',
            data: {
                id: id,
